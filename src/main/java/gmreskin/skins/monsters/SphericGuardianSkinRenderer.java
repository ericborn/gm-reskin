...
public class SphericGuardianSkinRenderer extends SkinRenderer {
    public SphericGuardianSkinRenderer(String skinPath) {
        super(skinPath);
        if (this.isSkinLoaded()) {
            this.animation.scale = 1.0F;
            this.animation.addTriggerEvent("0", animation -> SphericGuardianSkinRenderer.this.animation.setCurAnimation("idle"));
        }
    }
    ...
    public void update() {
        ...
        this.animation.yPosition = this.owner.hb.cY + this.owner.animY;
