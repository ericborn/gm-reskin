...
public class ChosenSkinRenderer extends SkinRenderer {
    public ChosenSkinRenderer(String skinPath) {
        super(skinPath);
        if (this.isSkinLoaded()) {
            this.animation.scale = 0.8F;
            this.animation.addTriggerEvent("0", animation -> ChosenSkinRenderer.this.animation.setCurAnimation("idle"));
        }
    }
