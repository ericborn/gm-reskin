...
public class FungiBeastSkinRenderer extends SkinRenderer {
    public FungiBeastSkinRenderer(String skinPath) {
        super(skinPath);
        if (this.isSkinLoaded()) {
            this.animation.scale = 1.0F;
            this.animation.addTriggerEvent("0", animation -> FungiBeastSkinRenderer.this.animation.setCurAnimation("idle"));
        }
    }
