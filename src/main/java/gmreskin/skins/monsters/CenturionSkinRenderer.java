...
public class CenturionSkinRenderer extends SkinRenderer {
    public CenturionSkinRenderer(String skinPath) {
        super(skinPath);
        if (this.isSkinLoaded()) {
            this.animation.scale = 1.3F;
            this.animation.addTriggerEvent("0", animation -> CenturionSkinRenderer.this.animation.setCurAnimation("idle"));
        }
    }
