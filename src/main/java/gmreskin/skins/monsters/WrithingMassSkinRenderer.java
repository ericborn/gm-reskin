...
public class WrithingMassSkinRenderer extends SkinRenderer {
    public WrithingMassSkinRenderer(String skinPath) {
        super(skinPath);
        if (this.isSkinLoaded()) {
            this.animation.scale = 1.2F;
            this.animation.addTriggerEvent("0", animation -> WrithingMassSkinRenderer.this.animation.setCurAnimation("idle"));
        }
    }
